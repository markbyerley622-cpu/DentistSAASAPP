  ...
  return (
    <div className="space-y-6 max-w-4xl">
      ...
      <SettingsSection
        ...
        description="Connect your Twilio account to enable AI phone handling"
        icon={Phone}
      >
        <div className="space-y-4">
          {/* Auto-config notice */}
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-success-400/70 mt-1">
                  Once connected, Twilio webhooks are automatically configured. Missed calls will instantly trigger AI follow-ups.
                </p>
              </div>
            </div>
          </div>
      ...
      <SettingsSection
        title="AI Greeting"
        description="Customize how the AI greets callers"
        icon={Sparkles}
      >
        <div className="space-y-4">
          {/* Practice name badge */}
          <div className="p-3 rounded-lg bg-accent-500/10 border border-accent-500/20">
            <p className="text-xs text-accent-400">
              Your practice name <span className="font-semibold">"{user?.practiceName}"</span> is automatically included in greetings.
            </p>
          </div>
          ...
          <div className="input-group">
            ...
            <textarea
              value={(() => {
                ...
                const defaultGreeting = `Hello! Thank you for calling ${practiceName}. This is our AI assistant. How can I help you today?`;
              ...
              placeholder={`Hello! Thank you for calling ${user?.practiceName || 'our practice'}. This is our AI assistant. How can I help you today?`}
            />
            <p className="text-xs text-dark-500 mt-2">
              This is what the AI will say when following up on missed calls
            </p>
          </div>
          <button onClick={handleSaveAiGreeting} disabled={saving} className="btn-primary">
            {saving ? <Loader2 className="w-4 h-4 animate-spin" /> : <Save className="w-4 h-4" />}
            <span className="ml-2">Save Greeting</span>
          </button>
        </div>
      </SettingsSection>
              ...
              <div>
                ...
                <p className="text-sm text-dark-400">
                  {calendarConnected
                    ...
                    : 'Link your calendar to enable automatic booking'}
                </p>
              </div>
            </div>
            {calendarConnected ? (
      ...
      <SettingsSection
        ...
        description="Add time slots the AI can offer to callers (used when Google Calendar is not connected)"
        icon={CalendarClock}
      >
        <div className="space-y-4">
          {/* Info banner */}
